          ...
          data: (requests) {
            ...
            return Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                ...requests.map(
                  (r) => _RequestTile(requestId: r.id, fromUser: r.fromUser),
                ),
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: AppColors.accentVolt.withValues(alpha: 0.3)),
      ),
      child: Row(
        children: [
          CircleAvatar(
  ...
  void _confirmDelete(BuildContext context, WidgetRef ref) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
          'This action is irreversible. All your match history and squad data will be lost.',
        ),
        actions: [
          TextButton(
